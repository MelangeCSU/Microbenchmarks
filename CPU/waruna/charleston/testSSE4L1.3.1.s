...
.L5:
	...
	movdqa	%xmm11, %xmm0
	addl	28(%rsp), %edx
	movdqa	(%rax,%rsi,4), %xmm12
	movdqa	%xmm13, %xmm4
	movdqa	(%rax,%rdi,4), %xmm10
	movdqa	%xmm12, %xmm3
	paddd	%xmm11, %xmm4
	pmaxsd	%xmm7, %xmm4
	movdqa	(%rax,%rcx,4), %xmm9
	paddd	%xmm11, %xmm3
	pmaxsd	%xmm8, %xmm3
	movdqa	%xmm10, %xmm2
	movdqa	%xmm9, %xmm1
	movdqa	%xmm4, (%rax,%r13,4)
	paddd	%xmm11, %xmm2
	pmaxsd	%xmm6, %xmm2
	paddd	%xmm11, %xmm1
	pmaxsd	%xmm5, %xmm1
	movdqa	%xmm3, (%rax,%r12,4)
	movdqa	%xmm2, (%rax,%rbp,4)
	movdqa	%xmm1, (%rax,%rbx,4)
	movdqa	(%rax,%r11,4), %xmm7
	movdqa	(%rax,%r15,4), %xmm8
	movdqa	%xmm7, %xmm1
	movdqa	(%rax,%r10,4), %xmm6
	movdqa	%xmm8, %xmm3
	paddd	%xmm11, %xmm1
	pmaxsd	%xmm13, %xmm1
	movdqa	%xmm1, %xmm4
	movdqa	(%rax,%r8,4), %xmm5
	movdqa	%xmm6, %xmm2
	paddd	%xmm11, %xmm3
	pmaxsd	%xmm12, %xmm3
	movdqa	%xmm1, (%rax)
